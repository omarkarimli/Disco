...
class InnerTube {
    ...
    suspend fun getSearchSuggestions(
        client: YouTubeClient,
        input: String,
    ) = httpClient.post("disco/get_search_suggestions") {
        ytClient(client)
        setBody(
    ...
    suspend fun getQueue(
        ...
        playlistId: String?,
    ) = httpClient.post("disco/get_queue") {
        ytClient(client)
        setBody(
            GetQueueBody(
                context = client.toContext(locale, visitorData, null),
