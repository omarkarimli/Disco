...
import com.omarkarimli.disco.ui.component.Material3SettingsGroup
import com.omarkarimli.disco.ui.component.Material3SettingsItem
import com.omarkarimli.disco.ui.component.ReleaseNotesCard
...
fun SettingsScreen(
    ...
    Column(
        ...
        val openAppSettingsErrorString = stringResource(R.string.open_app_settings_error)
                        ...
                        Material3SettingsItem(
                            ...
                            onClick = {
                                try {
                                    ...
                                    when (e) {
                                        is ActivityNotFoundException -> { context.toast(openAppSettingsErrorString) }
                                        is SecurityException -> { context.toast(openAppSettingsErrorString) }
                                        else -> { context.toast(openAppSettingsErrorString) }
                                    }
                                }
                            }
                        )
